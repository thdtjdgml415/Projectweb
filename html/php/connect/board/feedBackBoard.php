                    ...
                    <div class="board_inner container">
                        <div class="board_box">
                            ...
                            <div class="board_search">
                                <form action="boardSearch.php" name="boardSearch" method="get">
                                    <fieldset>
                                        ...
                                        <input type="hidden" name="searchBoard" id="searchBoard" value="feedBackBoard"/>
                            ...
                            <div class="board_pages">                          
                                <ul>
                                <?php
                                    $sql = "SELECT count(feedBackBoardID) FROM feedBackBoard";
                                    $result = $connect -> query($sql);

                                    $boardCount = $result -> fetch_array(MYSQLI_ASSOC);
                                    $boardCount = $boardCount['count(feedBackBoardID)'];
                                    // echo $boardCount;
                                    //총 페이지 갯수
